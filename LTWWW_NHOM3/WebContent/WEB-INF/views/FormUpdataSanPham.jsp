												...
												<li class="nav-item "><a class="a-img" href="#"
													...
													<ul class="item_small">
														<li><a href="dsSanPham_QuanLy"
															title="Danh sách sản phẩm">DANH SACH SẢN PHẨM</a></li>
				...
				<form action="suaSanPham">
					...
					<div class="form-group">
						<label for="txtname">Tên sản phẩm</label> <input
							...
							required="required" value="${suasp.tenSanPham }">
					</div>
					...
					<div class="form-group">
						<label for="txtname">Mô tả sản phẩm</label> <input
							...
							required="required" value="${suasp.moTa }">
					</div>
					...
					<div class="form-group">
						<label for="txtquantity">Số lượng sản phẩm</label> <input
							...
							required="required" value="${suasp.soLuongNhap }">
					</div>
					<!-- Giá sản phẩm -->
					<div class="form-group">
						...
						<input
							...
							required="required" value="${suasp.donGia}" step="100000">
							
					</div>
					<!-- Ngày sản xuất sản phẩm -->
					<div class="form-group">
						<label for="txtngay">Ngay sản phẩm</label> <input
							class="form-control" type="date" name="txtngaysua"
							max="10"
							required="required" value="${suasp.ngaySanXuat }">
					</div>
					...
					<button type="submit" class="btn btn-primary" name="btnsubmit">Thêm
						sản phẩm</button>
				</form>
			</div>
		</div>
