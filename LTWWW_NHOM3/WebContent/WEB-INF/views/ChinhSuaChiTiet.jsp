										...
										<nav class="header-nav">
											<ul class="item_big">
												...
												<li class="nav-item "><a class="a-img" href="#"
													...
													<ul class="item_small">
														<li><a href="dsSanPham_QuanLy" title="Xe đạp điện">DANH
																SACH SẢN PHẨM</a></li>
														<li><a href="themSanPham" title="Xe điện">THÊM
																SẢN PHẨM</a></li>
						...
						<form method="POST" action="capnhatChiTiet">
							<tr>
								...
								<td><input class="form-control text-center" type="text"
									name="txtsoLuong" value="${c.soLuong }"></td>
								<td><input type="hidden" name="maDonHang"
									value="${c.donHang.maDonHang}" /> <input type="hidden"
									name="maSanPham" value="${c.sanPham.maSanPham }" /> <input
