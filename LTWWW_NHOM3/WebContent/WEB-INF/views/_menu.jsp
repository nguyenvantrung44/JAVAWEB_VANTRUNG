					...
					<nav class="header-nav ">
						<ul class="item_big">
							...
							<li class="nav-item "><a class="a-img" href=""
								...
								<ul class="item_small">
									<li><a href="honda" title="Xe Đạp Điện Honda">Xe Đạp Điện Honda</a></li>
									<li><a href="yamaha" title="Xe Đạp Điện Yamaha">Xe Đạp Điện Yamaha</a></li>
									<li><a href="dkbike" title="Xe Đạp Điện DK Bike">Xe Đạp Điện DK Bike</a></li>
									<li><a href="hitasa" title="Xe Đạp Điện Hitasa">Xe Đạp Điện Hitasa</a></li>
									<li><a href="sunny" title="Xe Đạp Điện DK Bike">Xe Đạp Điện HK Bike</a></li>
							...
							<div class="aside-content">
								<nav class="nav-category navbar-toggleable-md">
									<ul class="nav navbar-pills">
										...
										<li class="nav-item "><a href="honda"
											class="nav-link a1">Xe Đạp Điện Honda</a></li>
										<li class="nav-item "><a href="yamaha"
											class="nav-link a1">Xe Đạp Điện Yamaha</a></li>
										<li class="nav-item "><a href="dkbike"
											class="nav-link a1">Xe Đạp Điện DK Bike</a></li>
										<li class="nav-item "><a href="hitasa"
											class="nav-link a1">Xe Đạp Điện Hitasa</a></li>
										<li class="nav-item "><a href="sunny"
											class="nav-link a1">Xe Đạp Điện HkBike</a></li>
							...
							<div id="demo" class="carousel slide" data-ride="carousel">
								...
								<div class="carousel-inner">
									<div class="carousel-item active">
										<img src="images/bn1.jpg" alt="xe dap dien" width="1100"
											height="600">
									</div>
									<div class="carousel-item">
										<img src="images/bn2.jpg" alt="the gioi xe dien" width="1100"
											height="600">
									</div>
									<div class="images/slider_1.jpg">
										<img src="images//slider_1.jpg" alt="xe may dien" width="1100"
											height="600">
									</div>
								</div>
